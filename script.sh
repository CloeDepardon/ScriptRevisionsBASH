...
function menu {
    ...
    optionsAcces=("Ouvrir un fichier" "Renommer un fichier" "Copier un fichier" "Supprimer un fichier" "Chercher un terme dans un fichier" "Créer un dossier" "Ouvrir un dossier" "Renommer un dossier" "Supprimer un dossier" "Retour au menu principal" "Quitter") 
...
### ACCEDER A UN DOSSIER ###
    ...
    NC='\033[0m' # No Color
        ...
        pwd
        echo -e "${COLOR}Contenu du dossier :${NC}"
        ls
        ...
        then
            ...
            read -e nomFichier
            echo -e "${COLOR}Contenu du fichier :${NC}"
            cat $nomFichier
            sousmenuAcces
        fi
    ...
    then
        ...
        echo -e "${COLOR}Vous êtes ici :${NC}" 
        pwd
        echo -e "${GREEN}Voici les fichiers présents dans $nomDossier ${NC}"
        ls
        sousmenuAcces
    fi
}
